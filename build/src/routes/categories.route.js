...
exports.categoriesRoutes.post("/", (0, validator_middleware_1.validator)({ schema: categories_dtos_1.createCategorySchema, type: validator_middleware_1.ParansType.BODY }), controller.create);
